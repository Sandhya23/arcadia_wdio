...
var sanitizeErrorMessage = function sanitizeErrorMessage(e) {
    ...
    stack = stack.filter(function (e) {
        return !e.match(/(wdio-sync\/(build\/index.js|node_modules\/fibers)|- - - - -)/g);
    });
...
var _executeSync2 = function executeSync(fn, resolve, reject) {
    ...
    try {
        ...
        if (repeatTest) {
            return _executeSync2(fn, resolve, reject, --repeatTest, args);
        }
    ...
    return origFn(function (done) {
        ...
        executeHooksWithArgs(before)['catch'](function (e) {
            ...
            if (isAsync() || hookFn.name === 'async') {
                return _executeAsync2.call(_this3, hookFn, repeatTest);
            }

            return new Promise(function (resolve, reject) {
                return Fiber(function () {
                    return _executeSync2.call(_this3, hookFn, resolve, reject, repeatTest);
                }).run();
            });
        }).then(function () {
...
var runSpec = function runSpec(specTitle, specFn, origFn) {
    ...
    return origFn(specTitle, function (resolve) {
        ...
        Fiber(function () {
            return _executeSync2.call(_this4, specFn, resolve, reject, repeatTest);
        }).run();
    });
};
